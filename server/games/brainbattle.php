...
function generateTaskData($type, $skipExternalGeneration = false, $excludedSignatures = [])
{
    ...
    if ($type === 'alchemy') {
        $recipes = [
            ...
            ['items' => ['🐟', '🍚'], 'res' => '🍣', 'name' => 'Суши'],
            ['items' => ['🌱', '🌧️'], 'res' => '🌾', 'name' => 'Урожай'],
            ['items' => ['📄', '✂️'], 'res' => '🎊', 'name' => 'Конфетти'],
            ['items' => ['🐮', '🥛'], 'res' => '🧀', 'name' => 'Сыр'],
            ['items' => ['🧁', '🕯️'], 'res' => '🎂', 'name' => 'Торт'],
            ...
            ['items' => ['🎭', '🎬'], 'res' => '🎞️', 'name' => 'Фильм'],
            ['items' => ['🎨', '🧑'], 'res' => '🧑‍🎨', 'name' => 'Художник'],
            ['items' => ['🧱', '🪟'], 'res' => '🏢', 'name' => 'Здание'],
            ['items' => ['🩺', '🏥'], 'res' => '👩‍⚕️', 'name' => 'Врач'],
            ['items' => ['🚒', '🔥'], 'res' => '🧯', 'name' => 'Тушение'],
            ['items' => ['🚑', '🩺'], 'res' => '🏥', 'name' => 'Больница'],
    ...
    if ($type === 'fact_check') {
        $facts = [
            ...
            ['text' => 'Крылья бабочек покрыты мельчайшими чешуйками.', 'is_true' => true],
            ['text' => 'Правильно хранящийся мед может сохраняться очень долго.', 'is_true' => true],
            ['text' => 'Отпечатки пальцев коалы очень похожи на человеческие.', 'is_true' => true],
            ['text' => 'У осьминога три сердца.', 'is_true' => true],
            ['text' => 'В Антарктиде нет белых медведей.', 'is_true' => true],
            ['text' => 'Розеттский камень помог расшифровать египетские иероглифы.', 'is_true' => true],
            ...
            ['text' => 'Угол квадрата может иметь любую величину от 1 до 179 градусов.', 'is_true' => false],
            ...
            ['text' => 'В нотной записи пауза означает повышение громкости.', 'is_true' => false],
            ...
            ['text' => 'Год на любой планете длится ровно 365 земных суток.', 'is_true' => false],
            ...
            ['text' => 'Мрамор образуется из застывшей лавы.', 'is_true' => false],
            ['text' => 'Пемза всегда тонет в воде.', 'is_true' => false],
            ...
            ['text' => 'Панамский канал соединяет Средиземное и Красное моря.', 'is_true' => false],
        ...
        $trueFacts = [
            ...
            ['text' => 'Ключицы кошек не соединены с другими костями скелета.', 'is_true' => true],
        ...
        $moreTrueFacts = [
            ...
            ['text' => 'Дождевые черви дышат через влажную кожу.', 'is_true' => true],
            ...
            ['text' => 'Семена фасоли развиваются внутри стручка.', 'is_true' => true],
            ['text' => 'Внутри фортепиано есть струны.', 'is_true' => true],
            ['text' => 'У обычной игральной кости шесть граней.', 'is_true' => true],
        ...
        $moreFalseFacts = [
            ...
            ['text' => 'Глубина океана везде одинакова.', 'is_true' => false],
            ...
            ['text' => 'Все реки текут строго с севера на юг.', 'is_true' => false],

            ['text' => 'У Венеры есть два естественных спутника.', 'is_true' => false],
            ['text' => 'У Земли два Солнца.', 'is_true' => false],
            ['text' => 'Кометы всегда движутся по идеально круглым орбитам.', 'is_true' => false],
            ['text' => 'Лунное затмение происходит каждое полнолуние.', 'is_true' => false],
            ['text' => 'Все звезды имеют одинаковую температуру поверхности.', 'is_true' => false],
            ['text' => 'Гранит образуется из спрессованного песка.', 'is_true' => false],
            ['text' => 'Все вулканы извергают только жидкую лаву.', 'is_true' => false],
            ['text' => 'Айсберги состоят из замерзшей морской воды.', 'is_true' => false],

            ['text' => 'Туман образуется только при температуре ниже нуля.', 'is_true' => false],
            ['text' => 'Растения получают всю пищу только из почвы.', 'is_true' => false],
            ['text' => 'Роса выпадает из облаков как дождь.', 'is_true' => false],
            ['text' => 'Легкие перекачивают кровь по всему телу.', 'is_true' => false],
            ['text' => 'Все акулы должны постоянно плыть, чтобы дышать.', 'is_true' => false],
            ['text' => 'Рыбы-клоуны живут только в пресной воде.', 'is_true' => false],
            ['text' => 'Оперативная память сохраняет данные после полного отключения питания.', 'is_true' => false],
            ['text' => 'Ежи питаются только растительной пищей.', 'is_true' => false],

            ['text' => 'Муравьи относятся к паукообразным.', 'is_true' => false],
            ['text' => 'Морские выдры никогда не используют предметы как орудия.', 'is_true' => false],
            ['text' => 'Формат JPEG не использует сжатие изображений.', 'is_true' => false],
            ['text' => 'Все птицы умеют летать.', 'is_true' => false],
            ['text' => 'У медуз есть костный позвоночник.', 'is_true' => false],
            ['text' => 'Летучие мыши относятся к птицам.', 'is_true' => false],
            ['text' => 'Ноты записывают только цифрами.', 'is_true' => false],
            ['text' => 'Сонет всегда состоит из десяти строк.', 'is_true' => false],

            ['text' => 'Акварельные краски не смешивают с водой.', 'is_true' => false],
            ['text' => 'Гончарный круг используют для выдувания стекла.', 'is_true' => false],
            ['text' => 'Фреску пишут по стеклу.', 'is_true' => false],
            ['text' => 'Арфа относится к ударным инструментам.', 'is_true' => false],
            ['text' => 'Змеи моргают подвижными веками.', 'is_true' => false],
            ['text' => 'Материк Африка целиком находится в Северном полушарии.', 'is_true' => false],
            ['text' => 'Черное море является пресноводным озером.', 'is_true' => false],
            ['text' => 'Антарктида находится в Северном полушарии.', 'is_true' => false],

            ['text' => 'Гималаи находятся в Южной Америке.', 'is_true' => false],
            ['text' => 'Мадагаскар находится в Атлантическом океане.', 'is_true' => false],
            ['text' => 'Экватор не пересекает ни одной страны.', 'is_true' => false],
            ['text' => 'Балтийское море находится у берегов Австралии.', 'is_true' => false],
            ['text' => 'Новая Зеландия расположена в Северном Ледовитом океане.', 'is_true' => false],
            ['text' => 'Экватор проходит через Северный и Южный полюса.', 'is_true' => false],
            ['text' => 'Bluetooth требует физического кабеля для связи.', 'is_true' => false],
            ['text' => 'GPS-приемник отправляет свои координаты навигационным спутникам.', 'is_true' => false],

            ['text' => 'Меридианы нигде не пересекаются друг с другом.', 'is_true' => false],
            ['text' => 'Режим инкогнито скрывает посещенные сайты от интернет-провайдера.', 'is_true' => false],
            ['text' => 'Удаленный в корзину файл сразу исчезает с накопителя.', 'is_true' => false],
            ['text' => 'Разъем HDMI передает только звук.', 'is_true' => false],
            ['text' => 'Египет целиком находится в Южной Америке.', 'is_true' => false],
            ['text' => 'Гренландия является отдельным континентом.', 'is_true' => false],
            ['text' => 'Магнит притягивает любой металл.', 'is_true' => false],
            ['text' => 'Пчелиный воск получают из древесной смолы.', 'is_true' => false],

            ['text' => 'Северное сияние возникает из-за отражения лунного света от снега.', 'is_true' => false],
            ['text' => 'Все грибы производят пищу с помощью фотосинтеза.', 'is_true' => false],
            ['text' => 'Все виды стекла изготавливают только из кварцевого песка.', 'is_true' => false],
            ['text' => 'Олово при комнатной температуре находится в газообразном состоянии.', 'is_true' => false],
            ['text' => 'В пасмурный день предметы вообще не отбрасывают теней.', 'is_true' => false],
            ['text' => 'Азбука Морзе используется только для записи цифр.', 'is_true' => false],
    ...
    if ($type === 'ai_quiz') {
        ...
        $backups = [
            ...
            ['question' => 'Какое море омывает берега Болгарии?', 'options' => ['Черное', 'Балтийское', 'Красное', 'Северное'], 'correct_val' => 'Черное'],
            ...
            ['question' => 'Какое животное известно черно-белыми полосами?', 'options' => ['Зебра', 'Жираф', 'Антилопа', 'Носорог'], 'correct_val' => 'Зебра'],
            ...
            ['question' => 'У какой планеты сутки длиннее года?', 'options' => ['Венера', 'Марс', 'Юпитер', 'Нептун'], 'correct_val' => 'Венера'],
            ['question' => 'На флаге какой страны изображен кленовый лист?', 'options' => ['Канада', 'США', 'Австралия', 'Норвегия'], 'correct_val' => 'Канада'],
            ['question' => 'Какой язык является государственным в Австрии?', 'options' => ['Немецкий', 'Французский', 'Итальянский', 'Нидерландский'], 'correct_val' => 'Немецкий'],
            ['question' => 'Сколько фигур у игрока в начале шахматной партии?', 'options' => ['16', '12', '18', '20'], 'correct_val' => '16'],
            ['question' => 'Какой пролив разделяет Европу и Африку?', 'options' => ['Гибралтарский', 'Берингов', 'Магелланов', 'Босфор'], 'correct_val' => 'Гибралтарский'],
        ...
        $backups = array_merge($backups, [
            ...
            ['question' => 'Какой прибор измеряет электрическое напряжение?', 'options' => ['Вольтметр', 'Амперметр', 'Барометр', 'Термометр'], 'correct_val' => 'Вольтметр'],
            ...
            ['question' => 'Какое дерево дает шишки и относится к хвойным?', 'options' => ['Сосна', 'Липа', 'Осина', 'Яблоня'], 'correct_val' => 'Сосна'],
            ...
            ['question' => 'На каком континенте в дикой природе обитает красный кенгуру?', 'options' => ['Австралия', 'Азия', 'Африка', 'Южная Америка'], 'correct_val' => 'Австралия'],
            ['question' => 'Чем в основном питается большая панда?', 'options' => ['Бамбуком', 'Рыбой', 'Орехами', 'Травой саванны'], 'correct_val' => 'Бамбуком'],
            ['question' => 'Какое животное строит плотины?', 'options' => ['Бобр', 'Выдра', 'Барсук', 'Заяц'], 'correct_val' => 'Бобр'],
            ['question' => 'Какая из этих птиц преимущественно активна ночью?', 'options' => ['Сова', 'Ласточка', 'Чайка', 'Журавль'], 'correct_val' => 'Сова'],
            ...
            ['question' => 'Как расшифровывается аббревиатура CPU?', 'options' => ['Central Processing Unit', 'Computer Personal Unit', 'Central Power Utility', 'Core Program User'], 'correct_val' => 'Central Processing Unit'],
            ...
            ['question' => 'Как расшифровывается аббревиатура USB?', 'options' => ['Universal Serial Bus', 'United System Base', 'Universal Signal Band', 'User Storage Block'], 'correct_val' => 'Universal Serial Bus'],
            ...
            ['question' => 'Как устроена стандартная матрица QR-кода?', 'options' => ['Квадратная', 'Круглая', 'Треугольная', 'Овальная'], 'correct_val' => 'Квадратная'],
            ...
            ['question' => 'Кто написал роман «Дон Кихот»?', 'options' => ['Сервантес', 'Данте', 'Бальзак', 'Кафка'], 'correct_val' => 'Сервантес'],
            ...
            ['question' => 'Какие древние животные находятся в центре сюжета «Парка юрского периода»?', 'options' => ['Динозавры', 'Драконы', 'Акулы', 'Роботы'], 'correct_val' => 'Динозавры'],
            ['question' => 'Как зовут главного героя «Матрицы»?', 'options' => ['Нео', 'Рокки', 'Индиана', 'Рэмбо'], 'correct_val' => 'Нео'],
            ['question' => 'Как зовут персонажа «Звездных войн» в черном шлеме и маске?', 'options' => ['Дарт Вейдер', 'Хан Соло', 'Йода', 'Чубакка'], 'correct_val' => 'Дарт Вейдер'],
            ...
            ['question' => 'В каком театральном жанре партии исполняют пением?', 'options' => ['Опера', 'Балет', 'Пантомима', 'Натюрморт'], 'correct_val' => 'Опера'],
            ...
            ['question' => 'Сколько касаний мяча разрешено команде в волейболе до возврата сопернику, не считая блока?', 'options' => ['3', '2', '4', '5'], 'correct_val' => '3'],
...
JSON: {\"question\": \"...\", \"options\": [\"...\", \"...\", \"...\", \"...\"], \"correct_index\": 0}";
        ...
        return ['type' => 'ai_quiz', 'title' => 'Викторина', 'question' => $bk['question'], 'options' => $bk['options'], 'correct_val' => $bk['correct_val']];
    }
