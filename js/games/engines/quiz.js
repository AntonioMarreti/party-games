...
(function () {
    ...
    function renderQuizLayout(wrapper, task) {
        ...
        <div class="bb-round-shell bb-round-shell--compact">
            <div class="bb-game-badge">
                <i class="bi bi-robot me-1"></i> ${task.title || 'AI Quiz'}
            </div>
            <div class="bb-question-card">
                ${task.is_ai ? '<div class="bb-question-kicker">Создано AI</div>' : '<div class="bb-question-kicker">Быстрый вопрос</div>'}
                <div class="bb-question-text animate__animated animate__fadeIn" style="font-size: ${qSize}; line-height: 1.3;">
                    ${task.question}
                </div>
            </div>
