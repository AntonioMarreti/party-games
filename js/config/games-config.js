...
window.AVAILABLE_GAMES = [
    ...
    },
    {
        ...
        promoImage: '',
        description: 'Классическая подкидная карточная партия для 2–5 игроков.',
        longDescription: `
            <p><strong>Дурак</strong> — серверная версия Дурака для приватной комнаты на 2–5 игроков. Игроки атакуют, защищаются, подкидывают карты, переводят атаку и добирают из общей колоды.</p>
            <p><strong>Доступно:</strong></p>
            <ul>
                <li><strong>Честные руки:</strong> сервер хранит все карты, а игрок видит только свою руку.</li>
                <li><strong>Живые игроки:</strong> партия рассчитана на 2–5 участников, включая существующих ботов.</li>
                <li><strong>Колоды 36 и 52 карты:</strong> можно выбрать набор перед началом партии.</li>
            </ul>
        `,
        stats: { players: '2-5', time: '10-25 мин', difficulty: 'Средняя' },
        rules: [
