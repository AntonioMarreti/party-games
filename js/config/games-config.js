...
window.AVAILABLE_GAMES = [
    ...
    },
    {
        ...
        longDescription: `
            <p><strong>Дурак</strong> — серверная версия Дурака для приватной комнаты на 2–4 игроков. Игроки атакуют, защищаются, подкидывают карты, переводят атаку и добирают из общей колоды.</p>
